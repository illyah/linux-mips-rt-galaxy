...
static struct prom_pmemblock *__init prom_getmdesc(void)
{
	...
	if (ptr)
		...
		lexra_membase = RTGALAXY_DEFAULT_LEXRA_MEMBASE;
	...
	mdesc[3].size = RTGALAXY_DEFAULT_HIGHMEM_START - mdesc[3].base;

	/*
	 * kernel high memory
	 */
	mdesc[4].type = yamon_free;
	mdesc[4].base = RTGALAXY_DEFAULT_HIGHMEM_START;
...
#ifdef CONFIG_RTGALAXY_RECLAIM_BOOT_MEMORY
	{
