...
#define rtdbg(fmt,arg...)	printk(">>>> %s :: " fmt "\n", __FUNCTION__, ## arg)
...
static void rtgalaxy_usbphy_init(uint8_t port)
{
				...
				rtgalaxy_reg_writel(rdata, RTGALAXY_USB_EHCI_INSNREG05);
				WAIT_FOR_BUSY();
...
static void rtgalaxy_usbphy_setreg(uint8_t port, uint8_t addr, uint8_t data)
{
				...
				rtgalaxy_reg_writel(data, raddr);
				WAIT_FOR_BUSY();
...
void rtgalaxy_usbphy_setup(void)
{
				...
				rtgalaxy_reg_writel(0x00000001, RTGALAXY_USB_EHCI_INSNREG03);
				rtgalaxy_reg_writel(0x01000040, RTGALAXY_USB_EHCI_INSNREG01);
				...
				rtgalaxy_reg_writel(0x02001001, RTGALAXY_USB_OHCI_RH_DESC_A);
				rtgalaxy_reg_writel(0x00008001, RTGALAXY_USB_OHCI_RH_STATUS);
				rtgalaxy_reg_writel(0x00000000, RTGALAXY_USB_EHCI_PORTSC_0);
				mdelay(10);
				rtgalaxy_reg_writel(0x00001000, RTGALAXY_USB_EHCI_PORTSC_0);
}
